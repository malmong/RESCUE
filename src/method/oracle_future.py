...
exactly as training labels are (src.method.future_contrib.train.
...
from src.method.future_contrib.extract import capture_sequence_chunked
...
def _oracle_head_distribution(
    ...
    src.method.future_contrib.train.future_attention_distribution's inner loop,
