...
from src.method.future_contrib.extract import capture_sequence_chunked  # noqa: E402
from src.models.registry import available, load  # noqa: E402

# numerical core, imported verbatim from the recovered original
from src.method import features as ORIGMOD  # the 18 features (raw9 + rank9)
