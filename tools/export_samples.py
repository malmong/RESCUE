...
documents establish that a metric agrees.
    ...
    python tools/verify_samples.py            # recompute and compare
"""
...
from tools.export_per_document import details, evaluators  # noqa: E402
    ...
    for task, stem in SAMPLES.items():
        ...
        payload = {
            ...
            "note": ("Scores are the official LongBench metric on one document at a "
                     ...
                     "cell mean. Run tools/verify_samples.py to recompute them."),
            "documents": docs,
        }
